...
//! Estructura para almacenar la informacion de un alumno
 ...
 * @param[in]   espacio     Cantidad de bytes de cadena
 * @param[in]   alumno      Puntero a la estructura de datos del alumno
